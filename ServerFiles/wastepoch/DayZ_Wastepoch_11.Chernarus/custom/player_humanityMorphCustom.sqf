private ["_fractures","_playerUID","_charID","_model","_inventory","_old","_updates","_humanity","_medical","_worldspace","_zombieKills","_headShots","_humanKills","_banditKills","_friendlies","_tagList","_wpnType","_ismelee"];
...
[_model, _inventory] call player_switchModelCustom;
