// Pistols
DZMSpistolList = ["UZI_SD_EP1","M9SD","RH_g17sd","vil_apssd","vil_USP45SD","DDOPP_X3_b","RH_Deagleg"];

// Sniper Rifles
DZMSsniperList = ["BAF_LRR_scoped_W","DMR_DZ","M110_NVG_EP1","BAF_AS50_Scoped","m107","USSR_cheytacM200","vil_SR25SD","FHQ_MSR_DESERT"];

// Light Machineguns
DZMSmgList = ["MAAWS","SMAW","M47Launcher_EP1","MetisLauncher","Stinger","M110_TWS_EP1","m107_TWS_EP1","USSR_cheytacM200_sd"];

// Primary Rifles
DZMSprimaryList = ["SCAR_H_STD_EGLM_Spect","Pecheneg_DZ","M32_EP1","SCAR_L_STD_EGLM_RCO","AA12_PMC","BAF_LRR_scoped_W","DMR_DZ","M110_NVG_EP1","BAF_AS50_Scoped","m107","FHQ_ACR_WDL_HAMR_GL_SD","FHQ_ACR_WDL_HAMR_GL","RH_hk417sglacog"];
