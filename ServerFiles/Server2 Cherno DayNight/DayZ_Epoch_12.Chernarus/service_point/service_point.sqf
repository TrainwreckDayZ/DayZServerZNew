...
_servicePointClasses = ["MAP_SmallObj_money","SmallObj_money"]; // service point classes (add "FuelPump_DZ" to use the dynamic Epoch fuel pumps)
...
_rearm_costs = ["ItemBriefcase100oz",1]; // 1 briefcase
