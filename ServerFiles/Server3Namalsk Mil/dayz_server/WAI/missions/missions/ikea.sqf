...
[_position,"Ikea"] execVM "\z\addons\dayz_server\WAI\missions\compile\markers.sqf";
...
if (_playerPresent) then {
	...
	diag_log format["WAI: Mission Ikea Ended At %1",_position];
	[nil,nil,rTitleText,"Survivors have secured the Ikea Crate!", "PLAIN",10] call RE;
} else {
	...
	diag_log format["WAI: Mission Ikea timed out At %1",_position];
	[nil,nil,rTitleText,"Survivors did not secure the Ikea Crate in time!", "PLAIN",10] call RE;
};
