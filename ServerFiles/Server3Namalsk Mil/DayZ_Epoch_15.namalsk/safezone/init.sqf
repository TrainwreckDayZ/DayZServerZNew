...
_safezones = [
	[[6281.39,9404.28],100, "awols air vehilces"], // awols air vehilces
	[[4702.44,8925.58],100, "fry and phil's weapons/ammo"], // fry and phil's weapons/ammo
	[[4305.8,4779.58],100, "Brensk Neutral Camp"] // Brensk Neutral Camp
];
