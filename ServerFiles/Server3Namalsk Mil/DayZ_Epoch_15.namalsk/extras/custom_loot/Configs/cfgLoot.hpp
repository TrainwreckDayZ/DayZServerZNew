class CfgLoot {
	...
	militarybackpacks[] = {
		...
		,{"DZ_LargeGunBag_EP1", 0.6}
	};
	militaryammo[] = {
		{"2000Rnd_762x51_M134",0.1}
		,{"29Rnd_30mm_AGS30", 0.6}
	...
	assaultrifles[] = {
		...
		,{"M4A1", 0.12}
		,{"M4A1_Aim",0.11}
		,{"M4A1_AIM_SD_camo", 0.15}
		,{"M4A1_HWS_GL_camo", 0.14}
		,{"M4A3_CCO_EP1", 0.11}
		,{"Sa58P_EP1", 0.11}
		,{"Sa58V_CCO_EP1", 0.14}
		,{"Sa58V_EP1", 0.12}
		,{"Sa58V_RCO_EP1", 0.14}
		,{"m8_compact", 0.13}
		,{"m8_sharpshooter", 0.14}
		,{"m8_holo_sd", 0.12}
		,{"m8_carbine", 0.15}
		,{"BAF_L85A2_RIS_SUSAT", 0.12}
		,{"BAF_L85A2_RIS_Holo", 0.11}
		,{"M4A1_HWS_GL_SD_Camo", 0.11}
	};
	assaultrifleammo[] = {
