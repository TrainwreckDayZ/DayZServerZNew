...
if (true) then
{
  _this = createVehicle ["FoldChair", [12011.427, 12644.017, 1.5258789e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_1 = _this;
  _this setDir -125.70265;
  _this setPos [12011.427, 12644.017, 1.5258789e-005];
};

_vehicle_2 = objNull;
if (true) then
{
  _this = createVehicle ["FoldTable", [12012.961, 12644.735, -3.0517578e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_2 = _this;
  _this setDir 19.492338;
  _this setPos [12012.961, 12644.735, -3.0517578e-005];
};

_vehicle_4 = objNull;
if (true) then
{
  _this = createVehicle ["FoldChair", [12012.872, 12645.996], [], 0, "CAN_COLLIDE"];
  _vehicle_4 = _this;
  _this setDir 18.442556;
  _this setPos [12012.872, 12645.996];
};

_vehicle_6 = objNull;
if (true) then
{
  _this = createVehicle ["FoldChair", [12013.79, 12645.671, -6.1035156e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_6 = _this;
  _this setDir 18.789759;
  _this setPos [12013.79, 12645.671, -6.1035156e-005];
};

_unit_101 = objNull;
if (true) then
{
  _this = createAgent ["Soldier_Sniper_KSVK_PMC", [12012.593, 12643.586], [], 0, "CAN_COLLIDE"];
  _unit_101 = _this;
  _this setDir 1;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
...
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [12030.9, 12700.8,  0.001], [], 0, "CAN_COLLIDE"];
  _vehicle_981 = _this;
  _this setPos [12030.9, 12700.8,  0.001];
};
//ServerTraderFOBGUBA
_unit_133 = objNull;
if (true) then
{
  _this = createAgent ["Hooker4", [14221.722, 14105.669, -136.80661], [], 0, "CAN_COLLIDE"];
  _unit_133 = _this;
  _this setDir 26.538639;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = createVehicle ["HeliHEmpty", [14230.327, 14150.126, -1.5258789e-005], [], 0, "CAN_COLLIDE"];
  _vehicle_981 = _this;
