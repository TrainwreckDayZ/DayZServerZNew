...
if (isServer) then {
	...
	[] spawn compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\traders.sqf"; //traders
	[] spawn compile preprocessFileLineNumbers "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\buildings.sqf"; //All static buildings moved to mission.sqm. use this file ONLY for donators!
...
[] spawn {
	...
	[] spawn compile preprocessFileLineNumbers "R3F_ARTY_AND_LOG\init.sqf";
