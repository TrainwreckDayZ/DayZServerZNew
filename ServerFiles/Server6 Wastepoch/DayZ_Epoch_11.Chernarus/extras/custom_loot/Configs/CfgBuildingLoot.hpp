...
class CfgBuildingLoot {
	...
	class Residential : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"pistols", "cfglootweapon"}, {"ItemKnife", "generic"}, {"ItemMatchbox_DZE", "generic"}, {"", "generic"}, {"militarybackpacks", "backpack"}, {"tents", "single"}, {"", "military"}, {"PartPlywoodPack", "magazine"}, {"clothes", "single"}, {"specialclothes", "single"}, {"WeaponHolder_MeleeCrowbar", "object"}, {"sniperrifles", "cfglootweapon"}};
		itemChance[] = {0.4, 0.1, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.04};
		itemTypeSmall[] = {{"ItemSodaMdew", "magazine"}, {"ItemSodaRbull", "magazine"}, {"ItemSodaOrangeSherbet", "magazine"}, {"pistols", "cfglootweapon"}, {"ItemKnife", "weapon"}, {"ItemMatchbox_DZE", "weapon"}, {"", "generic"}, {"", "military"}, {"clothes", "single"}, {"specialclothes", "single"}};
		itemChanceSmall[] = {0.01, 0.01, 0.02, 0.12, 0.02, 0.01, 0.38, 0.04, 0.01, 0.01};
	};
	...
	class Office : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"pistols", "cfglootweapon"}, {"ItemKnife", "generic"}, {"ItemMatchbox_DZE", "generic"}, {"", "generic"}, {"assaultrifles", "cfglootweapon"}, {"militarybackpacks", "backpack"}, {"tents", "single"}, {"", "military"}, {"PartPlywoodPack", "magazine"}, {"clothes", "single"}, {"specialclothes", "single"}, {"WeaponHolder_MeleeCrowbar", "object"}, {"ItemBriefcaseEmpty", "magazine"}};
		itemChance[] = {0.11, 0.02, 0.01, 0.31, 0.05, 0.04, 0.01, 0.02, 0.02, 0.01, 0.01, 0.03, 0.01};
		itemTypeSmall[] = {{"ItemSodaMdew", "magazine"}, {"ItemSodaRbull", "magazine"}, {"ItemSodaOrangeSherbet", "magazine"}, {"pistols", "cfglootweapon"}, {"ItemKnife", "weapon"}, {"ItemMatchbox_DZE", "weapon"}, {"", "generic"}, {"", "military"}, {"clothes", "single"}, {"specialclothes", "single"}, {"ItemDocument", "magazine"}};
		itemChanceSmall[] = {0.01, 0.01, 0.02, 0.15, 0.05, 0.03, 0.31, 0.04, 0.16, 0.02, 0.03};
	};
	...
	class Industrial : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"ItemFuelBarrel", "magazine"}, {"", "generic"}, {"", "military"}, {"PartGeneric", "magazine"}, {"PartWheel", "magazine"}, {"PartFueltank", "magazine"}, {"PartEngine", "magazine"}, {"PartGlass", "magazine"}, {"PartVRotor", "magazine"}, {"ItemJerrycan", "magazine"}, {"WeaponHolder_ItemHatchet_DZE", "object"}, {"ItemKnife", "military"}, {"ItemToolbox", "weapon"}, {"ItemWire", "magazine"}, {"ItemTankTrap", "magazine"}, {"ItemKeyKit", "weapon"}, {"CinderBlocks", "magazine"}, {"MortarBucket", "magazine"}};
		itemChance[] = {0.01, 0.17, 0.04, 0.04, 0.05, 0.03, 0.08, 0.01, 0.04, 0.07, 0.07, 0.06, 0.01, 0.04, 0.01, 0.04, 0.02};
		itemTypeSmall[] = {{"", "generic"}, {"", "military"}, {"ItemKeyKit", "weapon"}};
		itemChanceSmall[] = {0.5, 0.14, 0.01};
	};
	...
	class IndustrialFuel : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"ItemGenerator", "magazine"}, {"ItemFuelPump", "magazine"}, {"", "generic"}, {"", "military"}, {"PartGeneric", "magazine"}, {"PartWheel", "magazine"}, {"PartFueltank", "magazine"}, {"PartEngine", "magazine"}, {"PartGlass", "magazine"}, {"PartVRotor", "magazine"}, {"ItemJerrycan", "magazine"}, {"WeaponHolder_ItemHatchet_DZE", "object"}, {"ItemKnife", "military"}, {"ItemToolbox", "weapon"}, {"ItemWire", "magazine"}, {"ItemTankTrap", "magazine"}, {"ItemKeyKit", "weapon"}};
		itemChance[] = {0.01, 0.01, 0.18, 0.04, 0.04, 0.05, 0.01, 0.03, 0.04, 0.01, 0.04, 0.07, 0.07, 0.06, 0.01, 0.04, 0.01};
		itemTypeSmall[] = {{"", "generic"}, {"", "military"}, {"ItemKnife", "weapon"}, {"ItemKeyKit", "weapon"}};
		itemChanceSmall[] = {0.5, 0.14, 0.03, 0.01};
	};
	...
	class Farm : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"ItemJerrycan", "magazine"}, {"", "generic"}, {"farmweapons", "cfglootweapon"}, {"PartPlankPack", "magazine"}, {"WeaponHolder_ItemHatchet_DZE", "object"}, {"ItemFuelBarrel", "magazine"}, {"WeaponHolder_ItemMachete", "object"}, {"ItemFishingPole", "weapon"}, {"ItemSledgeHandle", "magazine"}};
		itemChance[] = {0.05, 0.3, 0.18, 0.08, 0.05, 0.01, 0.03, 0.01, 0.01};
		itemTypeSmall[] = {{"", "generic"}, {"", "military"}, {"ItemSledgeHead", "magazine"}};
		itemChanceSmall[] = {0.79, 0.6, 0.4};
	};
	...
	class Supermarket : Default {
		...
		itemType[] = {{"pistols", "cfglootweapon"}, {"ItemKnife", "generic"}, {"ItemMatchbox_DZE", "generic"}, {"", "generic"}, {"assaultrifles", "cfglootweapon"}, {"militarybackpacks", "backpack"}, {"tents", "single"}, {"", "food"}, {"PartPlywoodPack", "magazine"}};
		itemChance[] = {0.2, 0.05, 0.05, 0.2, 0.2, 0.2, 0.2, 0.3, 0.2};
		itemTypeSmall[] = {{"ItemSodaMdew", "magazine"}, {"ItemSodaRbull", "magazine"}, {"ItemSodaOrangeSherbet", "magazine"}, {"pistols", "cfglootweapon"}, {"ItemKnife", "weapon"}, {"ItemMatchbox_DZE", "weapon"}, {"", "generic"}, {"", "food"}, {"ItemMixOil", "magazine"}};
		itemChanceSmall[] = {0.1, 0.01, 0.03, 0.08, 0.01, 0.04, 0.21, 0.24, 0.03};
	};
	...
	class HeliCrash : Default {
		...
		lootChance = 0.7;
		lootPos[] = {};
		itemType[] = {{"assaultrifles", "cfglootweapon"}, {"submachinegun", "cfglootweapon"}, {"sniperrifles", "cfglootweapon"}, {"AA12_PMC", "weapon"}, {"", "military"}, {"20Rnd_B_AA12_HE", "magazine"}, {"MedBox0", "object"}, {"Stinger", "weapon"}, {"Stinger", "magazine"}, {"militaryclothes", "single"}, {"BAF_AS50_scoped", "weapon"}, {"m107", "weapon"}, {"RPG7V", "weapon"}, {"PG7V", "magazine"}, {"MAAWS", "weapon"}, {"MAAWS_HEDP", "magazine"}, {"2000Rnd_762x51_M134", "single"}};
		itemChance[] = {0.1, 0.03, 0.05, 0.2, 0.35, 0.4, 0.05, 0.05, 0.1, 0.05, 0.1, 0.2, 0.15, 0.2, 0.1, 0.15, 0.5};
	};
	...
	class Hospital : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"", "hospital"}, {"MedBox0", "object"}};
		itemChance[] = {0.9, 0.4};
	...
	class Military : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"pistols", "cfglootweapon"}, {"assaultrifles", "cfglootweapon"}, {"sniperrifles", "cfglootweapon"}, {"submachinegun", "cfglootweapon"}, {"ItemKnife", "military"}, {"ItemGPS", "weapon"}, {"militarybackpacks", "backpack"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"ItemEtool", "weapon"}, {"ItemSandbag", "magazine"}, {"machineguns", "cfglootweapon"}};
		itemChance[] = {0.2, 0.2, 0.2, 0.2, 0.03, 0.1, 0.2, 0.2, 0.1, 0.3, 0.05, 0.2, 0.2};
		itemTypeSmall[] = {{"pistols", "cfglootweapon"}, {"ItemGPS", "weapon"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"submachinegun", "cfglootweapon"}, {"ItemEtool", "weapon"}};
		itemChanceSmall[] = {0.15, 0.02, 0.09, 0.34, 0.26, 0.02, 0.01};
	};
	...
	class MilitaryIndustrial : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"pistols", "cfglootweapon"}, {"assaultrifles", "cfglootweapon"}, {"PartGeneric", "magazine"}, {"sniperrifles", "cfglootweapon"}, {"submachinegun", "cfglootweapon"}, {"PartWheel", "magazine"}, {"ItemGPS", "weapon"}, {"PartVRotor", "magazine"}, {"militarybackpacks", "backpack"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"ItemEtool", "weapon"}, {"ItemSandbag", "magazine"}, {"ItemFuelBarrel", "magazine"}, {"machineguns", "cfglootweapon"}};
		itemChance[] = {0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.7, 0.6, 0.6, 0.6, 0.6, 0.2, 0.6, 0.6, 0.6};
		itemTypeSmall[] = {{"pistols", "cfglootweapon"}, {"ItemGPS", "weapon"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"submachinegun", "cfglootweapon"}, {"ItemEtool", "weapon"}};
		itemChanceSmall[] = {0.6, 0.3, 0.6, 0.6, 0.6, 0.6, 0.2};
	};
	...
	class MilitarySpecial : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"assaultrifles", "cfglootweapon"}, {"machineguns", "cfglootweapon"}, {"pistols", "cfglootweapon"}, {"sniperrifles", "cfglootweapon"}, {"submachinegun", "cfglootweapon"}, {"AmmoBoxSmall_556", "object"}, {"AmmoBoxSmall_762", "object"}, {"ItemGPS", "weapon"}, {"Binocular_Vector", "military"}, {"militarybackpacks", "backpack"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"machinegunammo", "single"}, {"militaryclothes", "single"}, {"BAF_AS50_scoped", "weapon"}, {"m107", "weapon"}, {"RPG7V", "weapon"}, {"PG7V", "single"}, {"militaryammo", "single"}};
		itemChance[] = {0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.01, 0.03, 0.01, 0.02, 0.01, 0.02, 0.05};
		itemTypeSmall[] = {{"pistols", "cfglootweapon"}, {"AmmoBoxSmall_556", "object"}, {"AmmoBoxSmall_762", "object"}, {"ItemGPS", "weapon"}, {"Binocular_Vector", "weapon"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"machinegunammo", "single"}, {"militaryclothes", "single"}, {"29Rnd_30mm_AGS30", "magazine"}, {"50Rnd_127x107_DSHKM", "magazine"}, {"48Rnd_40mm_MK19", "magazine"}, {"100Rnd_127x99_M2", "magazine"}, {"machinegunammo", "single"}};
		itemChanceSmall[] = {0.6, 0.6, 0.6, 0.2, 0.4, 0.6, 0.6, 0.6, 0.6, 0.6, 0.15, 0.15, 0.15, 0.3, 0.6};
	};
	...
	class Hunting : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{"ItemKnife", "generic"}, {"ItemMatchbox_DZE", "generic"}, {"farmweapons", "cfglootweapon"}, {"", "military"}, {"WeaponHolder_ItemMachete", "object"}, {"", "hunter"}};
		itemChance[] = {0.01, 0.03, 0.03, 0.38, 0.02, 0.5};
		itemTypeSmall[] = {{"ItemKnife", "weapon"}, {"ItemMatchbox_DZE", "weapon"}, {"", "military"}, {"", "hunter"}};
		itemChanceSmall[] = {0.02, 0.04, 0.4, 0.5};
	};
	...
	class DynamicDebris : Default {
		...
		zombieChance = 0.3;
		zombieClass[] = {"zZombie_Base", "zZombie_Base", "z_teacher", "z_suit1", "z_suit2"};
		itemType[] = {{"ItemKnife", "generic"}, {"ItemMatchbox_DZE", "generic"}, {"ItemToolbox", "weapon"}, {"", "generic"}, {"", "food"}, {"PartGeneric", "magazine"}, {"PartWheel", "magazine"}, {"PartFueltank", "magazine"}, {"PartEngine", "magazine"}, {"PartGlass", "magazine"}, {"WeaponHolder_ItemJerrycan", "object"}};
		itemChance[] = {0.055, 0.055, 0.022, 0.169, 0.055, 0.066, 0.055, 0.033, 0.011, 0.078, 0.033};
	};
	...
	class DynamicDebrisMilitary : Default {
		...
		zombieChance = 0.3;
		zombieClass[] = {"z_soldier_pilot", "z_soldier_heavy"};
		itemType[] = {{"ItemEtool", "weapon"}, {"ItemSandbag", "magazine"}, {"", "military"}, {"MakarovSD", "weapon"}, {"ItemToolbox", "weapon"}, {"", "generic"}, {"", "food"}, {"PartGeneric", "magazine"}, {"PartWheel", "magazine"}, {"PartFueltank", "magazine"}, {"PartEngine", "magazine"}, {"PartGlass", "magazine"}, {"PartVRotor", "magazine"}, {"WeaponHolder_ItemJerrycan", "object"}};
		itemChance[] = {0.05, 0.1, 0.08, 0.01, 0.02, 0.15, 0.05, 0.06, 0.05, 0.03, 0.02, 0.03, 0.02, 0.03};
	};
	...
	class SupplyDrop : Default {
		...
		itemChance[] = {0.1, 0.3, 0.1, 0.1, 0.2, 0.1, 0.1, 0.1};
	};
	...
	class MassGrave : Default {
		...
		lootChance = 1;
		lootPos[] = {};
		itemType[] = {{M16A4, "weapon"}, {M16A4_ACG_GL, "weapon"}, {M9SD, "weapon"}, {"Pecheneg_DZ", "weapon"}, {"AKS_74_kobra", "weapon"}, {M24, "weapon"}, {SVD_CAMO, "weapon"}, {"BAF_LRR_scoped", "weapon"}, {M4SPR, "weapon"}, {M14_EP1, "weapon"}, {UZI_SD_EP1, "weapon"}, {"glock17_EP1", "weapon"}, {"M4A1_AIM_SD_camo", "weapon"}, {M16A4_ACG, "weapon"}, {"M4A1_HWS_GL_camo", "weapon"}, {"Mk_48_DZ", "weapon"}, {M4A3_CCO_EP1, "weapon"}, {"AmmoBoxSmall_556", "object"}, {"AmmoBoxSmall_762", "object"}, {"ItemGPS", "weapon"}, {"Binocular_Vector", "military"}, {"DZ_British_ACU", "object"}, {"DZ_CivilBackpack_EP1", "object"}, {"DZ_Backpack_EP1", "object"}, {"DZ_LargeGunBag_EP1", "object"}, {"", "medical"}, {"", "generic"}, {"", "military"}, {"PipeBomb", "magazine"}, {"Sa58V_RCO_EP1", "weapon"}, {"Sa58V_CCO_EP1", "weapon"}, {"G36_C_SD_camo", "weapon"}, {M40A3, "weapon"}, {"100Rnd_762x54_PK", "magazine"}, {"", "militaryclothes"}, {"WeaponHolder_ItemMachete", "object"}, {"SCAR_H_LNG_Sniper_SD", "weapon"}, {"2000Rnd_762x51_M134", "magazine"}, {KSVK_DZE, "weapon"}, {"m240_scoped_EP1_DZE", "weapon"}};
		itemChance[] = {0.03, 0.01, 0.02, 0.01, 0.01, 0.01, 0.01, 0.05, 0.01, 0.02, 0.03, 0.02, 0.01, 0.01, 0.01, 0.01, 0.01, 0.03, 0.03, 0.01, 0.01, 0.02, 0.02, 0.01, 0.01, 0.05, 0.05, 0.13, 0.1, 0.01, 0.01, 0.01, 0.01, 0.01, 0.05, 0.02, 0.01, 0.07, 0.01, 0.01};
	};
