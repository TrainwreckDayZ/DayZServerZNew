...
if (dayz_combat == 1) then {
	...
	_gear = [
		["AKS_74_UN_kobra","ItemMap","ItemToolbox","ItemCompass","Binocular","ItemMatchbox_DZE","Makarov"],
		[["30Rnd_545x39_AKSD",2],["ItemBandage",4],["8Rnd_9x18_Makarov",2],["ItemMorphine",2],["ItemBloodBag",2],["FoodCanBakedBeans",2],["ItemSodaPepsi",2],"ItemPainkiller","ItemEpinephrine"]
	];
	...
	_object = createVehicle ["Offroad_DSHKM_Gue_DZE3", _pos, [], 0, "CAN_COLLIDE"];
