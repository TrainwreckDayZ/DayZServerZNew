...
if (isServer) then {
	R3F_LOG_PUBVAR_point_attache = createVehicle ["HeliHEmpty", [0, 0, 0], [], 0, "CAN_COLLIDE"];
...
if (!isServer && !isDedicated) then {
	...
	deplacer_compile = compile preprocessFileLineNumbers "R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\deplacer.sqf";
