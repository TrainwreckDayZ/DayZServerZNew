...
/*  Key to open the menu  */ _OpenMenuKey = 0xDB;    /* google DIK_KeyCodes (0x3C is F2) */
/*  LOW ADMIN HERE        */ _LAdmins = ["0","0","0"]; //do not have a , at the end.
/*  NORMAL ADMIN HERE     */ _NAdmins = ["0"]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198038029716","76561197995016667","76561198119125204"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Welcome To"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "TrainwreckDayZ"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = " "; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "TrainwreckDayZ"; //do not use " in this text.
...
[
	...
	"s_player_dance","s_player_igniteTent","s_player_clothes","s_player_maintain_aread","s_player_maintain_area_previewd","s_player_scrollBandage","s_player_deploybike2","s_building_snapping","s_player_refuel_action","s_player_repair_action","s_player_rearm_action",
